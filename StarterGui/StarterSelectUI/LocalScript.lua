...
local JobDB = {
	Gambler = {
		...
		Ability = "Lucky Roll",
		AbilityDesc = "ทอยเต๋าพิเศษ: ได้ 1-2 = เสียเงิน, 3-4 = ปกติ, 5-6 = เงินx2",
		PassiveDesc = "โอกาสได้เงินพิเศษเมื่อผ่าน Start +20%"
	},
	Esper = {
		Name = "Esper",
		Icon = "🔮",
		...
		AbilityDesc = "ดูการ์ด 3 ใบบนสุดของ Deck แล้วเรียงใหม่ได้",
		PassiveDesc = "เห็น Pokemon ที่จะเจอในช่องถัดไป"
	},
	Shaman = {
		Name = "Shaman",
		Icon = "🌿",
		...
		Ability = "Spirit Heal",
		AbilityDesc = "ฟื้นฟู Pokemon ที่ตายแล้ว 1 ตัว (ใช้ได้ 1 ครั้ง/รอบ)",
		PassiveDesc = "Pokemon ฟื้น HP +20% เมื่อผ่าน Shop"
	},
	Biker = {
		Name = "Biker",
		Icon = "🏍️",
		...
		Ability = "Turbo Boost",
		AbilityDesc = "เพิ่มผลทอยเต๋า +2 ในเทิร์นนี้",
		PassiveDesc = "เดินเร็วขึ้น 30% บนกระดาน"
	}
}
