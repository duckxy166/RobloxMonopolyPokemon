...
local JobDB = {
	Gambler = {
		Name = "Gambler",
		Icon = "🎰",
		ImageId = "rbxassetid://75942296838387", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(255, 200, 50), -- Gold
		Description = "นักพนัน (Meowth) - เสี่ยงดวงเพื่อรางวัลใหญ่",
		Ability = "Lucky Guess",
	...
	Esper = {
		Name = "Esper",
		Icon = "🔮",
		ImageId = "rbxassetid://100692577736569", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(200, 100, 255), -- Purple
		Description = "จิตสัมผัส (Abra) - ควบคุมโชคชะตา",
		Ability = "Mind Move",
	...
	Shaman = {
		Name = "Shaman",
		Icon = "🌿",
		ImageId = "rbxassetid://116483660737253", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(100, 200, 100), -- Green
		Description = "หมอผี (Gastly) - สาปแช่งศัตรู",
		Ability = "Curse",
	...
	Biker = {
		Name = "Biker",
		Icon = "🏍️",
		ImageId = "rbxassetid://78350643264994", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(255, 100, 100), -- Red
		Description = "นักบิด (Ponyta) - เร็วแรงทะลุนรก",
		Ability = "Turbo Boost",
	...
	Trainer = {
		Name = "Trainer",
		Icon = "🎒",
		ImageId = "rbxassetid://82402506050437", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(100, 150, 255), -- Blue
		Description = "เทรนเนอร์ (Pikachu) - ผู้เชี่ยวชาญการ์ด",
		Ability = "Extra Hand",
	...
	Fisherman = {
		Name = "Fisherman",
		Icon = "🎣",
		ImageId = "rbxassetid://110045575465135", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(50, 150, 200), -- Cyan
		Description = "นักตกปลา (Magikarp) - ขโมยของคนอื่น",
		Ability = "Steal Card",
	...
	Rocket = {
		Name = "Rocket",
		Icon = "💀",
		ImageId = "rbxassetid://94626837696256", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(80, 80, 80), -- Dark Gray
		Description = "แก๊งร็อคเก็ต (Rattata) - ขโมยโปเกม่อน!",
	...
	NurseJoy = {
		Name = "NurseJoy",
		Icon = "💖",
		ImageId = "rbxassetid://114050032466781", -- 🖼️ ใส่รูปที่นี่
		Color = Color3.fromRGB(255, 150, 200), -- Pink
		Description = "คุณจอย (Clefairy) - รักษาโปเกม่อน",
		Ability = "Revive",
